    ...
    <div style={{ ...S }}>
      ...
      <div style={{ background: "rgba(255,255,255,0.03)", borderRadius: 12, padding: "16px 14px", border: "1px solid rgba(255,255,255,0.06)", marginBottom: 12 }}>
        <div style={{ display: "flex", gap: 5, marginBottom: 10 }}>
          ...
          <span style={{ fontSize: 10, fontWeight: 700, padding: "2px 7px", borderRadius: 5, background: "rgba(255,255,255,0.06)", color: "#94a3b8" }}>{q.type === "sata" ? "SATA" : q.type === "fib" ? "FILL IN" : q.type === "order" ? "ORDER" : q.type === "tf" ? "T/F" : "MC"}</span>
        </div>
